...
;(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        currencySettings: {
            locales: 'es-CL', // A string with a BCP 47 language tag, or an array of such strings
            currencyOptions: {
                style: 'decimal',
                currency: 'CLP',
    ...
    $.extend(SmartCart.prototype, {
        ...
        _addUpdateCartItem: function (p) {
            ...
            if (elmMain && elmMain.length > 0) {
                ...
                itemSummary += ' × <input type="number" min="0.5" max="1000" class="sc-cart-item-qty" value="' + this._getValueOrEmpty(p[this.options.paramSettings.productQuantity]) + '" />';
